...
| 2026-09-24 17点 | v1.26.0924.17 | 移除 FUNDING.yml；Docker 镜像由 ghcr.io 改为 Docker Hub temp2580/iwms（测试版）；修复容器手动停止报 137，加 dumb-init 处理 SIGTERM；补齐 CC BY-NC 4.0 署名声明与修改记录 |
